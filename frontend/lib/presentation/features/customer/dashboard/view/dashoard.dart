                ...
                SliverToBoxAdapter(
                  child: NearzySearchBar(
                    ...
                    onChanged: (value) {
                      context
                          .read<CustomerDataBloc>()
                          .add(CustomerDataSearchProductEvent(keyword: value));
                    },
                  ),
                ),
...
class _LocationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final location =
        context.read<CustomerDataRepository>().currentSelectedLocation;
    return Container(
      ...
      child: Row(
        children: [
          ...
          TextButton(
            ...
            child: Text('Change', style: AppTextStyles.link.copyWith(fontSize: 13)),
          ),
        ],
      ),
    );
